...
<template>
    <FormSection icon="user" @submitted="updateProfileInformation">
        <template #title> Podstawowe informacje </template>

        <template #description>
            Zaktualizuj podstawowe informacje i adres e-mail swojego konta.
        </template>
